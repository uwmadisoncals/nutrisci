...
<div class="mobileScroll">
  ...
  <?php if (function_exists( 'muneeb_ssp_slider')) {muneeb_ssp_slider( 988 );} ?>
   </div>
  	...
  	<ul class="slides">
  		<li class="flipin">
  			...
  			<div class="featureCaption">
  				<h2>Sue can change them in the template</h2>
  		...
  		<li class="flipin">
  			...
  			<div class="featureCaption">
  				<h2>But there is currently no easy way to change them on your end</h2> 				
