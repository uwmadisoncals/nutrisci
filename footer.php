	...
	<footer id="colophon" role="contentinfo">
       ...
       <div id="pre-footer">
                ...
                <li class="quick_links_list">
                    <ul>
                        <li class="quick_links_list_title">Students</li>
                         <?php wp_nav_menu( array( 'menu' => 'menu-footer', 'theme_location' => 'footer1' ) ); ?>
                    </ul>
              </li>
                <li class="quick_links_list">
                    <ul>
                        <li class="quick_links_list_title">Alumni &amp; Friends</li>
                         <?php wp_nav_menu( array( 'menu' => 'menu-footer', 'theme_location' => 'footer2' ) ); ?>
                    </ul>
            </li>
                <li class="quick_links_list">
                  <ul>
                    <li class="quick_links_list_title">Industry &amp; Community</li>
                        <?php wp_nav_menu( array( 'menu' => 'menu-footer', 'theme_location' => 'footer3' ) ); ?>
                </ul>
                </li>
                <li class="quick_links_list">
                    <ul>
                        <li class="quick_links_list_title">Faculty &amp; Staff</li>
                        <?php wp_nav_menu( array( 'menu' => 'menu-footer', 'theme_location' => 'footer4' ) ); ?>
                </li>                                
            </ul>
        </div>
        ...
        <div class="copyright">
	        ...
	        <img crest src="<?php echo get_template_directory_uri(); ?>/images/uwcrest_footer.png" style="height:63px; width:40px;"alt="University of Wisconsin Madison" align="center" />
        </div>
			<?php
